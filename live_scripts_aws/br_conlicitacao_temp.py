...
try:
    ...
    folders = os.listdir('//13.127.216.250/public/gecftp/tmp/br_conlicitacao_extract_file/br_conlicitacao_2024-04-17-04-00-09')
    for file in folders:
        file_path='//13.127.216.250/public/gecftp/tmp/br_conlicitacao_extract_file/br_conlicitacao_2024-04-17-04-00-09/'+str(file)
